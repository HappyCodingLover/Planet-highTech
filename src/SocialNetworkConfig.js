...
const SocialNetworkConfig = {
  ...
  onboardingConfig: {
    ...
    // welcomeTitle: IMLocalized('Planet-highTech'),
    welcomeTitle: 'Planet-highTech',
    welcomeCaption: `Sell what you don't need`,
    ...
    walkthroughScreens: [
      ...
      },
      {
        ...
        title: 'Sell',
        description: 'Wanna make some money, sell things',
      },
      {
